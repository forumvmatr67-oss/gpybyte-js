...
// Стандарт JPYByte
test('1 GPY = 1000 JPY', () => {
    const result = Converter.convert(1, Unit.GPY, Unit.JPY);
    if (result !== 1000) throw new Error(`Ожидалось 1000, получено ${result}`);
});
...
console.log('='.repeat(50));
console.log(`\n📊 Результаты: ${passed} пройдено, ${failed} не пройдено\n`);
